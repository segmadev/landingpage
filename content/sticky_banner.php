                    ...
                    <div
                        ...
                        <div class="flex items-center justify-center">
                            <div class="ml-auto"><a
                                    ...
                                    href="https://github.com/mearashadowfax/ScrewFast" target="_blank">Explore ScrewFast
                                    on GitHub <svg
                                        class="size-4 flex-shrink-0 transition duration-300 group-hover:translate-x-1"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <path d="m9 18 6-6-6-6"></path>
                                    </svg></a></div><button type="button"
                                ...
                                id="dismiss-button"><span class="sr-only">Dismiss</span> <svg
                                    class="size-5 flex-shrink-0" width="24" height="24" viewBox="0 0 24 24" fill="none"
