...
<section class="relative mx-auto max-w-[85rem] px-4 pb-24 pt-10 sm:px-6 lg:px-8">
                <div class="absolute left-0 top-[55%] scale-90 md:top-[20%] xl:left-[10%] xl:top-[25%]"><svg width="64"
                        height="64" fill="none" stroke-width="1.5" color="#ea580c" viewBox="0 0 24 24">
                ...
                <div class="absolute left-[85%] top-0 scale-75"><svg width="64" height="64" fill="none"
                        stroke-width="1.5" color="#fbbf24" viewBox="0 0 24 24">
                        ...
                        <path stroke="#fbbf24" stroke-linecap="round" stroke-linejoin="round" d="M10.5 19H9M15 19h-1.5">
                        </path>
                    </svg></div>
                <div class="absolute bottom-[5%] left-[60%] scale-[.6] xl:bottom-[15%] xl:left-[35%]"><svg width="64"
                        height="64" fill="none" stroke-width="1.5" color="#a3a3a3" viewBox="0 0 24 24">
                ...
                <div class="mx-auto mt-5 max-w-xl text-center">
                    <h2
                        ...
                        <?= $d->get_settings("action_title", 'content') ?></h2>
                </div>
                <div class="mx-auto mt-5 max-w-3xl text-center">
                    <p class="text-pretty text-lg text-neutral-600 dark:text-neutral-400">
                    <?= $d->get_settings("action_details", 'content') ?>
                    </p>
                </div>
                <div class="mt-8 flex justify-center gap-3"><a
                        class="text-white text-light group inline-flex items-center justify-center gap-x-3 rounded-full px-4 py-3 text-center text-sm font-medium text-neutral-700 ring-zinc-500 focus-visible:ring transition duration-300 outline-none border border-transparent bg-yellow-400 dark:focus:outline-none hover:shadow-2xl hover:shadow-yellow-500 2xl:text-base dark:ring-zinc-200"
