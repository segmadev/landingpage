...
!(function (a, b) {
  ...
  function L(a, b, c) {
      if (b.enablePagination) {
        console.log(b.enableFinishButton);
      var d =
          '<div id="custommessage" class="p-2"></div>'+
          '<{0} class="actions {1}"><ul role="menu" aria-label="{2}">{3}</ul></{0}>',
          e = '<li><a href="#{0}" role="menuitem">{1}</a></li>',
          s = '<li><a href="#{0}" style="display:none"></a><button class="btn btn-primary" role="menuitem">{1}</button></a></li>';
        f = "";
